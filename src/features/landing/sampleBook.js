export const SAMPLE_BOOK = {
  ...
  chapters: [
    ...
    },
    {
      ...
      paragraphs: [
        "Reading is not a race across pages. The useful pace is the one that lets an idea meet your own experience. Some ideas ask to be carried quickly, while others deserve a place to rest.",
