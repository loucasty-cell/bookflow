...
export async function parsePdf(file, onProgress) {
  ...
  if (totalPagesForOcr > 0) {
    ocrPageCount = await performLocalOcr(pagesNeedingOcr, totalPagesForOcr, pdf.numPages, reportProgress, pdf);
  } else {
...
async function performLocalOcr(pagesNeedingOcr, totalPagesForOcr, pdfNumPages, reportProgress, pdf) {
  reportProgress(
    26,
